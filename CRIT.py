...
class instagram:
	...
	def logo(self):
		for i in external:
			...
			prints(Panel(f"""
{P2}[{R2}01{P2}]. 𝙘𝙧𝙖𝙘𝙠 𝙞𝙙 𝙙𝙖𝙧𝙞 𝙥𝙚𝙣𝙘𝙖𝙧𝙞𝙖𝙣 𝙣𝙖𝙢𝙖   
{P2}[{R2}02{P2}]. 𝙘𝙧𝙖𝙘𝙠 𝙞𝙙 𝙙𝙖𝙧𝙞 𝙥𝙚𝙣𝙜𝙞𝙠𝙪𝙩         
{P2}[{R2}03{P2}]. 𝙘𝙧𝙖𝙘𝙠 𝙞𝙙 𝙙𝙖𝙧𝙞 𝙢𝙚𝙣𝙜𝙞𝙠𝙪𝙩𝙞        
{P2}[{R2}04{P2}]. 𝙘𝙧𝙖𝙘𝙠 𝙪𝙡𝙖𝙣𝙜 𝙝𝙖𝙨𝙞𝙡 𝙘𝙥
{P2}[{R2}05{P2}]. 𝙘𝙚𝙠 𝙝𝙖𝙨𝙞𝙡 𝙘𝙧𝙖𝙘𝙠
{P2}[{R2}06{P2}]. 𝙗𝙤𝙩 𝙖𝙪𝙩𝙤 𝙪𝙣𝙛𝙤𝙡𝙡𝙤𝙬
{P2}[{R2}07{P2}]. 𝙧𝙚𝙢𝙤𝙫𝙚 𝙡𝙞𝙨𝙚𝙣𝙨𝙞
{P2}[{R2}00{P2}]. 𝙠𝙚𝙡𝙪𝙖𝙧 ({M2} hapus cookie {P2})""",title=f"{M2}• {K2}• {H2}•{P2} MENU {H2}• {K2}• {M2}•",width=80,padding=(0,4),style=f"#FFFFFF"))
